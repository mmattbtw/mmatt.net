          ...
          return(
            <li key={release.basic_information.id} style={{listStyleType: "none"}}>
              <Grid align="center">
                ...
                <Grid.Col span={4}><p key={release.basic_information.id}>{release.basic_information.artists[0].name} - {release.basic_information.title} ({release.basic_information.formats[0].name})</p></Grid.Col>
              </Grid>
            </li>
          )
        })}
