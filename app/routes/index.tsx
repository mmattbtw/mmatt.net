        ...
        >
            ...
            >
                <Container>
                    ...
                    <p>
                        i enjoy collecting vinyl records, and i enjoy listening to music, in the next section, you will see some of the artists i like
                        to listen to!
                    </p>
                    ...
                    <h3>my playlist</h3>
                    <p>
                        i mainly used spotify's "liked songs" as my main playlist, but you can't make that public so the playlist below is a regularly
                        updated mirror of it, enjoy, or don't :^)
                    </p>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="https://www.youtube.com/watch?v=WunyRgaA_ws">virtual self- god rays</a> (required watching too, the
                            visuals/lights on this track is insane and i want to see it live one day)
                        </li>
                        <li>
                            <a href="https://open.spotify.com/track/432hUIl3ISDeytYW5XBQ5h?si=525a126aee36406d">kanye west - wolves</a> (this song
                            made me buy better headphones after listening to this song for the first time on some good headphones)
                        </li>
                        <li>
                            <a href="https://www.youtube.com/watch?v=DlSIznmujYM">sweet trip - pro: lov: ad</a>
                        </li>
                        <li>
                            <a href="https://www.youtube.com/watch?v=AC8h4HnWyys">SOPHIE - OIL OF EVERY PEARL'S UN-INSIDES</a> (i know this is an
                            album, but its worth it, listen to it <a href="https://cdn.7tv.app/emote/61e14854950a8915e1708862/4x">NOW</a>)
                        </li>
                        <li>
                    ...
                    <h2>socials</h2>
                    <p>
                        all of my socials are available on <a href="https://mm.omg.lol">mm.omg.lol</a>. i don't list them all here because they aren't
                        always going to be up to date, and my omg.lol page is much easier to just link everywhere and update, and it updates accross
                        all platforms.
                    </p>
                    ...
                    <p>
                        this site was made using the wonderful <a href="https://remix.run">remix.js</a> and <a href="https://mantine.dev/">mantine</a>
                        . it's hosted on vercel, and is open sourced here:{' '}
                        <a href="https://github.com/mmattbtw/remix-mmatt.net">mmattbtw/remix-mmatt.net</a>.
                    </p>

                    <h3>what's the deal with the scribbles?</h3>
                    <p>
                        if you took a look at my top artists, you can see that one of my top artists is porter robinson. one of his new aesthetic
                        things with his new album 'nurture' are these cool scribbles that i think look nice. anyways i pretty much just stole the idea
                        and worked it into my website. sorry nature boy but mr. mmattbtw has stolen your funny little scribbles for his website
                    </p>
                </Container>
            </main>
